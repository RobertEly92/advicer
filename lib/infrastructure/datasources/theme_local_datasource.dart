...
const CACHED_THEME_MODE_KEY = 'CACHED_THEME_MODE';
...
class ThemeLocalDatasourceImpl implements ThemeLocalDatasource {
  ...
  @override
  Future<void> cacheThemeData({required bool mode}) {
    return sharedPreferences.setBool(CACHED_THEME_MODE_KEY, mode);
  }

  @override
  Future<bool> getCachedThemeData() {
    final modeBool = sharedPreferences.getBool(CACHED_THEME_MODE_KEY);
    if (modeBool != null) {
